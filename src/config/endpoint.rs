...
/// A network endpoint consisting of address and port
///
/// This type is used for raft node endpoints and is stored in the config module
/// to avoid circular dependencies between config and raft types.
